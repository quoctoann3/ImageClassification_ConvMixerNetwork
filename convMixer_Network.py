...
"""
#wandb.init(project='OSCC_ConvMixer_')
...
#(x_train, y_train), (x_test, y_test) = tf.keras.preprocessing.image_dataset_from_directory('C:/00nqtoan_doc/09_OralCancer/dataset/train', class_mode='binary')
#/home/hail/Documents/t3/04_OralCancer/dataset/oscc
#(x_train, y_train), (x_test, y_test) = tf.keras.preprocessing.image_dataset_from_directory('/home/hail/Documents/t3/04_OralCancer/dataset/oscc')
#val_split = 0.1
...
def get_conv_mixer_256_8(
    image_size=224, filters=256, depth=8, kernel_size=7, patch_size=4, num_classes=2
):
